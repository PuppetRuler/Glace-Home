                ...
                <div class="row-span-1 hidden sm:block mt-8">
                  ...
                  >
                    <div class="flex w-full h-full items-center">
                      ...
                      >
                        <div
                          class="skeleton h-3 w-1/2 rounded opacity-50"
                        ></div>
                      </div>
                    </div>
                  </div>
...
.fade-slide-leave-active {
  /* 这里的 0.5s 与你的背景图过渡时间 var(--bg-img-transition) 保持同步 */
  transition: opacity 0.5s ease, transform 0.5s ease;
}

.fade-slide-enter-from {
  opacity: 0;
  transform: translateY(10px); /* 从下方 10px 处淡入 */
}

.fade-slide-leave-to {
  opacity: 0;
  transform: translateY(-10px); /* 向上方 10px 处淡出 */
}
</style>
